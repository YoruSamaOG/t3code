...
**Import from**. Chromium-based browsers can stay open during the import. Close Firefox before
importing from it, and allow an operating-system keyring unlock prompt if one appears.
